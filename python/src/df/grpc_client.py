...
try:
    ...
    raise ImportError("Please install the SDK with gRPC support: pip install dataflare-sdk[grpc]")


class APIKeyInterceptor(grpc.UnaryUnaryClientInterceptor, grpc.UnaryStreamClientInterceptor, grpc.StreamUnaryClientInterceptor, grpc.StreamStreamClientInterceptor):
...
class DFGRPCClient:
    ...
    def __init__(
        ...
        target: str = "rpc.dataflare.com:443"
    ):
